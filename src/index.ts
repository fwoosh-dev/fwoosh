...
const endent = (endentPackage as any).default as typeof endentPackage;
  ...
  options: [
    {
      name: "dir",
      description:
        "The directory that contains the mdx files for your website.",
      type: String,
      defaultOption: true,
      defaultValue: "docs",
    },
...
if (options) {
  buildWebsite(options as BuildWebsiteOptions);
}
