...
- add vitest plugin ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix names ([@hipstersmoothie](https://github.com/hipstersmoothie))
- run tests ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- don't show tools/panels if there are none ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix panel height in workbench ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- fix zoom plugin on safari ([@hipstersmoothie](https://github.com/hipstersmoothie))
